...
public class EntityWatcherBase extends EntityMob
{
    ...
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager.<Boolean>createKey(EntityWatcherBase.class, DataSerializers.BOOLEAN);
    private int lastCreepySound;
    private int targetChangeTime;

    public EntityWatcherBase(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityWatcherBase.class);
    }
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
        {
            private final EntityWatcherBase enderman;
            /** The player */
            private EntityPlayer player;
            private int aggroTime;
            private int teleportTime;

            public AIFindPlayer(EntityWatcherBase p_i45842_1_)
            {
